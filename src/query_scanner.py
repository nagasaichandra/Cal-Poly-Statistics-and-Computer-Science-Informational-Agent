...
variable_query_dict = {'major-courses' : '''SELECT course_name 
                    FROM course WHERE course_area like "%[major]";'''}
...
user_variables = find_variables(question)
print(clean_response_query(answer, user_variables))
